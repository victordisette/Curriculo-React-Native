...
            source={require('./assets/curriculoimg.jpeg')} 
          />
...
  _       <Text style={styles.itemTitle}>Graduação em Análise e Desenvolvimento de Sistemas</Text>
...
        _ <Text style={styles.bulletPoint}>• Diagnóstico e resolução de problemas de conectividade utilizando ferramentas específicas.</Text>
...
_         <Text style={styles.bodyText}><Text style={styles.bold}>Sistemas Operacionais:</Text> Windows (Server, 7, 10, 11) e Linux.</Text>
